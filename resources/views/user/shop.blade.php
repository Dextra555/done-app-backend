        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="shop-sidebar">
              ...
              <div
                class="p-32 mb-32 border border-gray-100 shop-sidebar__box rounded-8"
              >
                ...
                <ul class="overflow-y-auto max-h-540 scroll-sm">
                  <li class="mb-24">
                    <a
                      href="{{ route('product.details.two') }}"
                      class="text-gray-900 hover-text-main-600"
                      >Mobile & Accessories (12)</a
                    >
                  </li>
                  <li class="mb-24">
                    <a
                ...
                <div class="custom--range">
                  ...
                  <div class="flex-wrap-reverse gap-8 mt-24 flex-between">
                    ...
                    <div class="gap-8 custom--range__content flex-align">
                      <span class="flex-shrink-0 text-gray-500 text-md"
                        >Price:</span
                      >
                      <input
                        type="text"
              ...
              >
                ...
                <div class="gap-8 mb-20 flex-align position-relative">
                  <label
                    class="cursor-pointer position-absolute w-100 h-100"
                    for="rating5"
                  >
                  </label>
                ...
                <div class="gap-8 mb-20 flex-align position-relative">
                  ...
                  <div class="gap-4 flex-align">
                    ...
                    <span class="text-xs fw-medium text-warning-600 d-flex"
                      ><i class="ph-fill ph-star"></i
                    ></span>
                    <span class="text-xs text-gray-400 fw-medium d-flex"
                      ><i class="ph-fill ph-star"></i
                    ></span>
                  </div>
              ...
              >
                ...
                <ul class="overflow-y-auto max-h-540 scroll-sm">
                  <li class="mb-24">
                    <div
                      class="form-check common-check common-radio checked-black"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                  ...
                  <li class="mb-24">
                    <div
                      class="form-check common-check common-radio checked-primary"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                  ...
                  <li class="mb-24">
                    <div
                      class="form-check common-check common-radio checked-gray"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                  ...
                  <li class="mb-24">
                    <div
                      class="form-check common-check common-radio checked-success"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                  ...
                  <li class="mb-24">
                    <div
                      class="form-check common-check common-radio checked-danger"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                  ...
                  <li class="mb-24">
                    <div
                      class="form-check common-check common-radio checked-white"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
                  ...
                  <li class="mb-0">
                    <div
                      class="form-check common-check common-radio checked-purple"
                    >
                      <input
                        class="form-check-input"
                        type="radio"
          ...
          <div class="col-lg-9">
            ...
            <div class="flex-wrap gap-16 mb-40 flex-between">
              ...
              <div class="flex-wrap gap-16 position-relative flex-align">
                ...
                <div
                  class="gap-4 text-gray-500 position-relative flex-align text-14"
                >
                  <label for="sorting" class="flex-shrink-0 text-inherit"
                    >Sort by:
                  </label>
                  <select
                    class="w-auto form-control common-input px-14 py-14 text-inherit rounded-6"
                    id="sorting"
                  >
            ...
            <ul class="flex-wrap gap-16 pagination flex-center">
              <li class="page-item">
                <a
                  class="w-64 h-64 border border-gray-100 page-link flex-center text-xxl rounded-8 fw-medium text-neutral-600"
                  href="#"
                >
              ...
              <li class="page-item active">
                <a
                  class="w-64 h-64 border border-gray-100 page-link flex-center text-md rounded-8 fw-medium text-neutral-600"
                  href="#"
                  >01</a
                >
              </li>
